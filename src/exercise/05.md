...
Parados sobre el elemento, podemos ir a la consola y usar por ej $0.className y
nos va a dar la className que tiene el objeto actual seleccionado, se puede
hacer con cualquier propiedad del elemento.
